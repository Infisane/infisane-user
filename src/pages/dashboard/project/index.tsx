...
const Project = () => {
  ...
  return (
    <div className="min-h-screen pb-[10%]">
      {show && (
        <CustomModal isOpen={show} onClose={handleClose} className="lg:w-[464px]">
      ...
      <div className="p-[32px]">
        ...
        <div className="flex justify-center items-center w-full flex-wrap gap-[24px]">
          <Link
            to={`/project/${1}`}
            className="p-[24px] rounded-[8px] bg-white w-[48%] border-[#D7D7D7] border-[1px]"
          >
            <p className="text-[16px] text-dark font-[500] mb-4">Logo Design</p>
              ...
              <div>
                <div className="flex flex-col items-start gap-4">
                  ...
                  <div className="flex justify-start gap-2 items-center">
                    ...
                    <p className="text-[14px] font-[500] text-dark">Frontend</p>
                  </div>{" "}
                  <div className="flex justify-start gap-2 items-center">
                    <svg
                      width="20"
                    ...
                    <p className="text-[14px] font-[500] text-dark">Backend</p>
                  </div>
                </div>
          ...
          <Link  to={`/project/${1}`} className="p-[24px] rounded-[8px] bg-white w-[48%] border-[#D7D7D7] border-[1px]">
            <p className="text-[16px] text-dark font-[500] mb-4">Logo Design</p>
            <div className="flex justify-between items-center">
              <div>
                <div className="flex flex-col items-start gap-4">
